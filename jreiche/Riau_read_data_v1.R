...
#load s1
s1vv <- brick("/media/DATA2/ent004/Sumatra/stack/S1VV_stack_mt55_test.gri")
s1vv_date <- substr(getZ(s1vv),1,10)
s1vv_date

s1vh <- brick("/media/DATA2/ent004/Sumatra/stack/S1VH_stack_mt55_test.gri")
s1vh_date <- substr(getZ(s1vh),1,10)
s1vh_date

#load landsat ndvi
ndvi <- brick("/media/DATA2/ent004/Sumatra/stack/NDVI_res_stack_test.gri")
...
fm <- raster("/media/DATA2/ent004/Sumatra/GFW/Hansen_GFC-2015_10N_100E_2015_forest_mask_test.tif")
